            ...
            for (var m = start; m.isBefore(end); m.add('days', 1)) {                            
                ...
                for(var j=0;j<this.options.description.length;j++) {
                    ...
                    if(this.options.description[j].date == m.clone().format(this.options.selectedDateFormat)) { 
                        ...
                        saleenabled = this.options.description[j].isprice == true && this.options.description[j].isstopsale == false && this.options.description[j].allclosed == false;  
                ...
                data.items[data.items.length] = {        
                    ...
                    saleEnabled: (saleenabled) ? saleenabled : false
